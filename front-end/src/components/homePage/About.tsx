            ...
            <div className="flex-block justify-center items-center text-center mx-2 text-3xl">
                <div className="relative mb-3 animate-tableOfContentsOne">
                    ...
                    <div className="flex absolute top-0 w-screen justify-center text-center">
                        <a
                            href="#skills"
                            className="text-center w-fit text-titleFinal opacity-60 text-5xl cursor-pointer drop-shadow-[0_1.2px_1.2px_rgba(0,0,0,0.8)] hover:opacity-100 transition duration-300 linear"
                        >
                            Skills
                        </a>
                    </div>
                ...
                <div className="relative my-3 animate-tableOfContentsTwo">
                    ...
                    <div className="flex absolute top-0 w-screen justify-center text-center">
                        <a
                            href="#projects"
                            className="text-center text-titleFinal text-5xl opacity-60 cursor-pointer drop-shadow-[0_1.2px_1.2px_rgba(0,0,0,0.8)] hover:opacity-100 transition duration-300 linear"
                        >
                            Projects
                        </a>
                    </div>

        ...
        <div className="w-screen h-fit flex justify-center mt-20 bg-gray-800 z-40 pt-10">
            <div className="flex-block w-2/3 justify-center">
                ...
                <div className="w-full flex justify-center">
                    <div className="flex h-16 lg:h-20 w-fit justify-center items-center my-10 bg-gray-300 py-2 rounded-3xl">
                        ...
                        <div className="h-16 lg:h-20">
                            ...
                            >
                                <img
                                    src={github}
                                    className="max-h-full  sm:mx-5 lg:mx-10 p-3 drop-shadow-[0_1.2px_1.2px_rgba(0,0,0,0.8)] cursor-pointer"
                                />
                            </a>
                        </div>
                        <div className="h-16 lg:h-20">
                        ...
                        <div className="h-16 lg:h-20">
                            <a href="mailto:jjohnstone681@gmail.com">
                                <img
                                    src={email}
                                    className="max-h-full  sm:mx-5 lg:mx-10 p-2 drop-shadow-[0_1.2px_1.2px_rgba(0,0,0,0.8)] cursor-pointer"
                                />
                            </a>
                        </div>
                    </div>

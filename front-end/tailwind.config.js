    ...
    theme: {
        ...
        extend: {
            ...
            animation: {
                ...
                tableOfContentsOne: "floatIn 0.5s linear both",
                tableOfContentsTwo: "floatIn 0.5s linear 0.25s both",
                tableOfContentsThree: "floatIn 0.5s linear 0.5s both",
                tableOfContentsFour: "floatIn 0.5s linear 0.75s both",
                BEScFloat: "floatInBESc 0.5s linear both",
            },
        },
    },
    plugins: [],
